...
var questions: [Quest] = [
    ...
    Reading(answer: "I was too tired, so I just stayed at home.", kor: "너무 피곤하길래 그냥 집에 있었어요."),
    Reading(answer: "I realized I was too tired, so I just stayed at home.", kor: "너무 피곤하길래 그냥 집에 있었어요."),
    ...
    Reading(answer: "It’s too high, so lower it a little.", kor: "너무 높으니까 좀 낮춰 주세요."),
    Reading(answer: "Show me some other things, too.", kor: "다른 것도 보여 주세요."),
    Reading(answer: "I was too busy so I made another person do it.", kor: "제가 너무 바빠서 다른 사람한테 시켰어요."),
    ...
    Reading(answer: "I said it’s possible too.", kor: "그럴 수도 있다니까요."),
