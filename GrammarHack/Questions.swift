...
var questions: [Quest] = [
    MathFractions(
        phraseStart: "The pizza was divided into twelve slices. After the party, there were eight slices left. We ate",
        phraseEnd: "of the pizza.",
        answer: "one-third",
        kor: "(24 ➖ 8) ➗ 24 = 1/3"
    ),
    MathFractions(
        phraseStart: "The pizza was divided into sixteen slices. After the party, there were four slices left. We ate",
        phraseEnd: "of the pizza.",
    ...
    MathFractions(
        phraseStart: "The pizza was divided into twenty-four slices. After the party, there were eight slices left. We ate",
        phraseEnd: "of the pizza.",
        answer: "two-thirds",
        kor: "(24 ➖ 8) ➗ 24 = 2/3"
    ),
    MathFractions(
        phraseStart: "The pizza was divided into nine slices. After the party, there were three slices left. We ate",
        phraseEnd: "of the pizza.",
        answer: "two-thirds",
        kor: "(9 ➖ 3) ➗ 9 = 2/3"
    ),
    MathFractions(
        phraseStart: "The pizza was divided into twenty-four slices. After the party, there were sixteen slices left. We ate",
        phraseEnd: "of the pizza.",
        answer: "one-third",
        kor: "(24 ➖ 16) ➗ 24 = 1/3"
    ),
